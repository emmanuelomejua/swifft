                ...
                <ScrollView vertical>
                    <View style={tw`flex justify-start items-center gap-12 bg-white min-h-full py-12 px-2`}>
                        <View style={tw`flex justify-center items-center gap-3 bg-white rounded-lg shadow-md px-8 py-6`}>
                            ...
                            <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-xl text-black text-center')}>Your Airtime to cash purchase was successful</Text>
                        </View>
                        ...
                        <View style={tw`flex justify-center items-stretch gap-8 rounded-lg shadow-md bg-white px-8 py-4 w-full`}>
                            ...
                            <View style={tw`flex flex-row justify-between items-center gap-24`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>Airtime Amount</Text>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>1000</Text>
                            </View>
                            <View style={tw`flex flex-row justify-between items-center gap-24`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>Amount in Cash</Text>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>&#x20A6; 1000</Text>
                            </View>
                            <View style={tw`flex flex-row justify-between items-center gap-24`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>Phone Number</Text>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>9999994</Text>
                            </View>
                            <View style={tw`flex flex-row justify-between items-center gap-24`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>Transaction Date</Text>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>19-02-3024</Text>
                            </View>
                            <View style={tw`flex flex-row justify-between items-center gap-24`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>Trannsaction Time</Text>
...
export default AirtimeToCashSuccess;