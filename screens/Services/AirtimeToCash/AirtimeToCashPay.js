                ...
                <ScrollView vertical style={tw`h-full bg-white`} overScrollMode='never'>
                    <View style={tw`flex justify-start items-start gap-6 p-4`}>
                        <View style={tw`flex flex-row justify-start items-start gap-3`}>
                            ...
                            <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-black text-xl')}>Airtime to Cash</Text>
                        </View>

                        <View style={tw`flex justify-center items-center gap-5 px-3 py-4`}>
                            <View style={tw`flex justify-start items-start gap-3`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Bold' }, 'text-black text-base')}>Amount in Cash</Text>
                                <CustomInput placeholder="Enter phone number" style={tw`border-2 border-[#f2f2f2] bg-[#f2f2f2] px-6 py-4 min-w-full rounded-lg`} keyboardType={'numeric'} maxLength={11} />
                            </View>
                            <View style={tw`flex justify-start items-start gap-3`}>
                            ...
                            <View style={tw`flex justify-start items-start gap-3`}>
                                <Text style={tw.style({ fontFamily: 'PTSans-Bold' }, 'text-black text-base')}>Airtime Amount</Text>
                                <Dropdown
                                    onFocus={handleFocus}
                                    onBlur={handleBlur}
                                    style={tw`h-[50px] border-gray-400 border-2 rounded-lg min-w-full p-4`}
                        ...
                        <View style={tw`flex justify-center items-center px-4`}>
                            ...
                            >
                                ...
                                <View style={tw`px-4 py-2 flex justify-center items-center gap-6`}>
                                    <Feather name='x' size={18} color={"#000"} style={tw`ml-auto`} onPress={handleCancelButton} />
                                    <View style={tw`flex justify-center items-center gap-2`}>
                                        <Image source={require("../../../assets/data.png")} />
                                        <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-base text-black text-center')}>Airtime To Cash</Text>
                                    </View>
                                    ...
                                    <View style={tw`flex flex-row justify-between items-center w-full`}>
                                        <Text>Airtime Amount</Text>
                                        <Text>10GB for a month</Text>
                                    </View>
                                    <View style={tw`flex flex-row justify-between items-center w-full`}>
                                        <Text>Amount in Cash</Text>
                                        <Text>3000</Text>
                                    </View>
                                    ...
                                    >
                                        <View style={tw`flex justify-center items-center gap-5`}>
                                            <Feather name='x' size={18} color={"#000"} style={tw`ml-auto px-4`} />
                                            ...
                                            <CustomButton style={tw`flex flex-row justify-center items-center bg-[#29bb00] w-4/5 py-3 px-4 rounded-full`}>
                                                <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-white text-center text-base')} onPress={() => navigation.navigate("Cash Success")}>
                                                    Confirm
                                                </Text>
                                            </CustomButton>
                                        </View>
...
export default AirtimeToCashPay;