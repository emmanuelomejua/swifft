...
const RehargeCardPrintingSuccess = () => {
        ...
        <ScrollView vertical>
          <View style={tw`flex justify-start items-center gap-12 bg-white min-h-full py-12 px-2`}>
            <View style={tw`flex justify-center items-center gap-3 bg-white rounded-lg shadow-md px-8 py-6`}>
              ...
              <Text style={tw.style({ fontFamily: 'PTSans-Regular' }, 'text-xl text-black text-center')}>Your Data was successfully purcahsed</Text>
            </View>
...
export default RehargeCardPrintingSuccess;